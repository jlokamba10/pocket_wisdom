  ...
  return (
    <section className="page">
      <div className="page-header">
        <h2>Alerts & Rules</h2>
        <p>Monitor alert activity and tune threshold rules for your equipment.</p>
      </div>
      ...
      <div className="panel">
        <div className="panel-header">
          <div>
            <h3>Alert Rules</h3>
            <p className="muted">Create and manage thresholds for your scope.</p>
          </div>
          {!showRuleForm ? (
            <button
              className="primary"
          ...
          <div className="form-panel">
            <form className="form-rows" onSubmit={onRuleSubmit}>
              ...
              {activeEquipment.length === 0 ? (
                <div className="form-error">Add equipment before creating alert rules.</div>
              ) : null}
            </form>
          </div>
        ) : null}
      ...
      <div className="panel">
        <div className="panel-header">
          <div>
            <h3>Alert Events</h3>
            <p className="muted">Filter and clear alerts in your scope.</p>
          </div>
        </div>
        ...
        {alertLoading ? (
          ...
          <div className="form-error">{alertError}</div>
        ) : alerts.length === 0 ? (
